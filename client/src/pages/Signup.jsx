    ...
    <div className="auth-container">
      <Box sx={{
        ...
        <Box component="form" onSubmit={onSubmit}>
          ...
          />
          <TextField
            fullWidth label="Email Address" variant="outlined" margin="normal" type="email"
          ...
          <Typography align="center" sx={{ color: 'rgba(255,255,255,0.5)' }}>
            ...
            <MuiLink component={Link} to="/login" sx={{ color: '#a78bfa', fontWeight: 600, textDecoration: 'none', '&:hover': { textDecoration: 'underline' } }}>
              Sign In
            </MuiLink>
          </Typography>
        </Box>
